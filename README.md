...
La tarea principal de la clasificación de imágenes es la aceptación de la imagen de entrada y la siguiente definición de su clase. Un humano puede determinar fácilmente que la imagen es de un tren descarrilado. Pero la computadora ve las imágenes de manera muy diferente:

![What we see vs what a computer sees](https://slideplayer.com/slide/6218949/20/images/6/Computer+vision+vs+human+vision.jpg)
...
![How CNN works](https://editor.analyticsvidhya.com/uploads/750710_QS1ArBEUJjjySXhE.png)
...
![Example of a simple neural network](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSz0eU0aKkm-PK1FG6E5y8gBkyEfOHGp8CCg&usqp=CAU)
...
1. Descargar miniconda del siguiente enlace: https://docs.conda.io/en/latest/miniconda.html y seguir los pasos del ejecutable.
2. Una vez termine la instalación, es necesario crear un nuevo ambiente que contenga Python 3.9.
- Para realizarlo debe ingresar a la consola de conda
![Anaconda prompt](https://www.tutorialexample.com/wp-content/uploads/2019/07/Anaconda-Prompt.png)
- Ejecutar la siguiente línea:

> Conda create --name snakes python=3.9

- Esto creara un ambiente llamado "snakes" el cual será el que se utilizara para el proyecto. Para activarlo se utiliza la siguiente línea
...
[https://github.com/hosamelsafty/Cats-VS-Dogs](https://github.com/hosamelsafty/Cats-VS-Dogs)
